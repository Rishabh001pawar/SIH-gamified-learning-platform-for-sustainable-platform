...
export default function SoilNutrientTestingMission() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8">
      <h1 className="text-4xl font-bold mb-6 text-green-700">Soil Nutrient Testing</h1>
      <img src="https://images.unsplash.com/photo-1563851086435-022212260f9b?q=80&w=2070&auto=format&fit=crop" alt="Soil Testing" className="rounded-xl mb-6 w-full h-64 object-cover" />
      <p className="mb-4">Perform soil tests and understand how to interpret results for optimal fertilization.</p>
      <h2 className="text-2xl font-bold mb-2 mt-6">Mission Steps</h2>
      <ul className="list-disc ml-6 mb-4">
        <li>Collect soil samples</li>
        <li>Send samples to lab or use a test kit</li>
        <li>Analyze results</li>
        <li>Apply recommended nutrients</li>
      </ul>
      <div className="mt-8 text-emerald-700 font-bold">Complete this mission to earn 80 points!</div>
